...
const BikeIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M15 6h-3l-3 11.5"/>
    <path d="M9.5 6H15l3 5.5H9"/>
...
export default function DeliveryBoyLayout() {
  ...
  const getActiveIndex = () => {
    ...
    if (p.includes("/deliveries")) return 1;
    return 0;
  };
      ...
      <nav className="relative py-3 px-3 flex-1 overflow-y-auto">
        ...
        <span
          ...
          style={{
            ...
            background:
              "linear-gradient(135deg,rgba(14,165,233,0.22),rgba(2,132,199,0.10))",
            border: "1px solid rgba(14,165,233,0.35)",
            opacity: indicator.opacity,
            transition:
              "top 0.3s cubic-bezier(0.4,0,0.2,1), height 0.3s, opacity 0.2s",
            zIndex: 0,
          }}
        />
        ...
        {NAV_ITEMS.map((item, i) => (
          <NavLink
            ...
            style={({ isActive }) => ({
              color: isActive ? "#7dd3fc" : "rgba(255,255,255,0.5)",
              zIndex: 1,
              textDecoration: "none",
            })}
          >
  ...
  return (
    ...
    >
      {/* ── Desktop Sidebar ── */}
      <aside
        className="hidden md:flex flex-col w-56 lg:w-60 shrink-0 h-screen sticky top-0"
        style={{
      ...
      <nav
        className="md:hidden fixed bottom-0 left-0 right-0 z-40 flex items-center px-1 py-1.5"
        style={{
      ...
      >
        <span
          ...
          style={{
            ...
            background:
              "linear-gradient(135deg,rgba(14,165,233,0.2),rgba(2,132,199,0.10))",
        ...
        {NAV_ITEMS.map((item, i) => (
          <NavLink
            ...
            style={({ isActive }) => ({
              color: isActive ? "#7dd3fc" : "rgba(255,255,255,0.38)",
              zIndex: 1,
              textDecoration: "none",
            })}
          >
      ...
      {showLogout && (
        ...
        >
          ...
          >
            ...
            >
              You'll be signed out of the delivery panel.
            </p>
